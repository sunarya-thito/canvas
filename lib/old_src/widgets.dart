    ...
    return FreeHitIgnorePointer(
      ...
      child: FreeHitOpacity(
        opacity: widget.state.targetReparent == null ||
            ...
            ? 1
            : widget.state.targetReparent!.item.layout is FlexLayout
                ? 0.5
                : 0,
                ...
                child: GroupWidget(
                  ...
                  children: [
                    ...
                    if (widget.state is CanvasObjectState) ...[
                      ...
                      if ((widget.state as CanvasObjectState).item.layout
                          is! FlexLayout)
                              ...
                              children: [
                                for (var group in value.groups)
                                  for (var ghost in group.selectedItems)
                                    Builder(
                                      builder: (context) {
                                        var commonParent = ghost
                                            .findCommonParent(widget.state);
