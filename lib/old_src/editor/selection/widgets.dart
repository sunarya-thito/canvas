    ...
    return IgnorePointer(
      child: ListenableBuilder(
        listenable: Listenable.merge(
            [selectionBox.start, selectionBox.end, editor.controller]),
        builder: (context, child) {
          Rect rect = selectionBox.rect;
          print('rebuild selection rect: $rect');
          Offset topLeft = editor.localToGlobal(rect.topLeft);
          Offset bottomRight = editor.localToGlobal(rect.bottomRight);
