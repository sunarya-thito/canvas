...
import 'package:canvas/old_src/editor/debug.dart';
...
abstract class CanvasItem {
  ...
  CanvasItemState createState({CanvasItemState? parent, CanvasEditor? editor});
...
abstract class CanvasItemState
  ...
  bool visitSnapAnchor(SnapAnchorVisitor visitor,
    ...
    if (editorOffset != null || parentHasEditorOffset || !item.allowSnapping) {
      return true;
    }
...
class CanvasRoot extends CanvasObject {
  ...
  @override
  CanvasRootState createState({CanvasItemState? parent, CanvasEditor? editor}) {
