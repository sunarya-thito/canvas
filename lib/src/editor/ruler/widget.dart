...
import 'package:canvas/src/editor/control/sessions/ruler_create.dart';
import 'package:canvas/src/editor/control/sessions/ruler_update.dart';
            ...
            children: [
              ...
              Positioned.fill(
                child: Listener(
                  behavior: HitTestBehavior.translucent,
                  onPointerDown: (event) {
                    if (widget.editor.selectedSnapGuideline != null) {
                      setState(() {
                        widget.editor.selectedSnapGuideline = null;
                      });
                    }
                  },
                ),
  ...
  Widget _buildSnapAnchorDraggable(CanvasSnapGuideline point, double width) {
    ...
    return ListenableBuilder(
      ...
      builder: (context, child) {
        ...
        double offset = point.offset * editor.zoom +
      ...
      child: MouseRegion(
        ...
        child: GestureDetector(
          ...
          onTap: () {
            setState(() {
              editor.selectedSnapGuideline = point;
            });
          },
          onPanStart: (details) {
            setState(() {
              ...
              editor.startControlSession(
                  _draggingSession =
                      RulerUpdateSnapAnchorControlSession(snapAnchor: point),
                  editorData.globalToLocal(details.globalPosition),
                  editorData.viewportSize);
            });
          },
              ...
              child: CustomPaint(
                painter: _RulerPainter(
                  hovered: _hoveredPoint ??
                      widget.editor.selectedSnapGuideline ??
                  ...
                  selected: widget.editor.selectedSnapGuideline,
